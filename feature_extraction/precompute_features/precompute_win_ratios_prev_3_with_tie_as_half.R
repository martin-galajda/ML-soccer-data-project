...
if (!file.exists('./data/matches_with_win_ratio_from_prev_3_matches_with_tie_as_half_win.csv')) {
  precompute.win.ratios.from.prev.matches(num.of.prev.matches.for.ratio = 3, with.tie.as.half.win = TRUE)
}
