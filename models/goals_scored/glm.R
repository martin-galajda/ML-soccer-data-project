...
# glm.family:  "poisson" or "gaussian"
# test.method: "last.season" or test random proportion (e.g. 20%)
run.glm = function (family,test.method) {
  ...
  # train models
  home.model = glm(home_team_goal ~ . - away_team_goal, family=family, data=matches.train[,features.train])
  away.model = glm(away_team_goal ~ . - home_team_goal, family=family, data=matches.train[,features.train])
