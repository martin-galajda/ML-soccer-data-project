...
results <- determine.best.subset.of.features(matches.for.training, features.for.predicting, make.lda.model, predict.type = "response", repeat.k.fold = 10)

best.features.subset.result.lda.exhaustive <- results

best.features.subset.result.lda.exhaustive <- values(best.features.subset.result.lda.exhaustive)


save(best.features.subset.result.lda.exhaustive, file="./results/match_result/saved_Rdata/best_feature_subset_lda_result_exhaustive.Rdata")
