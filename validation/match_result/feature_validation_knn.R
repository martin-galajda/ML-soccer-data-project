...
best.feature.subset.knn.result <- values(best.feature.subset.svm.result)
...
x.point.best <- which(unlist(CV.errors.greedy) == best.feature.subset.knn.result$lowest.CV.error.seen)
