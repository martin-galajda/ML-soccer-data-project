...
results <- determine.best.subset.of.features.using.greedy(matches.for.training, features.for.predicting, make.multinomial.logistic.regression.model, predict.type = "class", repeat.k.fold = 3)

best.feature.subset.logistic.result <- results

save(best.feature.subset.logistic.result, file="./results/match_result/saved_Rdata/best_feature_subset_logistic_result.Rdata")
